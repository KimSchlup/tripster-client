...
export default function RoadtripPage() {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            const idealPosition = window.innerHeight * 0.2;
    ...
    return (
        <div style={{ height: "100vh", width: "100%" }}>
            <Link href="/" style={{
                ...
                <img src="/logo-no-text-white.png" alt="Logo" style={{ width: "60px", height: "60px", borderRadius: "10%" }} />
            </Link>
            {/* ----------------- Vertical Sidebar ----------------- */}
            ...
            <div style={{
                ...
                onMouseEnter={e => e.currentTarget.querySelector('.hover-overlay')!.style.opacity = "0.1"}
